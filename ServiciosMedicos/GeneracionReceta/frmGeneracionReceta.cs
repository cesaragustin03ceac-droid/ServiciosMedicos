    ...
    public partial class frmGeneracionReceta : Form
    {
        ...
        private void CargarDatosPacienteEnReceta()
        {
            ...
            try
            {
                ...
                {
                    query = @"SELECT a.matricula AS MatriculaFinal,
                ...
                {
                    query = @"SELECT t.num_trabajador AS MatriculaFinal, 
                                 ar.nombre_area AS Area, 
                                 e.edad AS Edad, 
                                 e.sexo AS Sexo, 
                ...
                using (MySqlCommand cmd = new MySqlCommand(query, conexionAbierta))
                {
                    ...
                    using (MySqlDataReader lector = cmd.ExecuteReader())
                    {
                        if (lector.Read())
                        {
                            txtMatricula.Text = ValorO_Vacio(lector["MatriculaFinal"]);
                            txtNombre.Text = ValorO_Vacio(lector["NombreCompleto"]);
                            txtArea.Text = ValorO_Vacio(lector["Area"]);

                            this.areaPaciente = ValorO_Vacio(lector["Area"]);
                            this.edadPaciente = ValorO_Vacio(lector["Edad"]);
                            this.sexoPaciente = ValorO_Vacio(lector["Sexo"]);
                        }
                    }
                }
            }
